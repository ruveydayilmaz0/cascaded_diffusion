...
class CTCDataset(Dataset):
    ...
    def prepare_img_and_mask(self, idx):
        ...
        mask = torch.squeeze(F.interpolate(mask[None,None,...], [mask.shape[0]*4, mask.shape[1]*4], mode='nearest'))##
        ...
        img = torch.squeeze(F.interpolate(img[None,None,...], [64, 64], mode='nearest'))##
