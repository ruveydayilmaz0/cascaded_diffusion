...
class MorenoMaskDataset(Dataset):
    ...
    def extract_feats_dinov2(self, mask_filename):
        ...
        full_command = ["/work/scratch/yilmaz/miniconda3/envs/dinov2/bin/python", "datasets/dataset4dinov2.py", '--mask_filename', mask_filename]
        ...
        feats = torch.squeeze(F.interpolate(feats[None,None,...], [feats.shape[0]*13, feats.shape[1]*13], mode='nearest'))[:512,:512]
...
if __name__ == "__main__":
   dataset = MorenoMaskDataset("/netshares/BiomedicalImageAnalysis/Resources/LiveCellMinerDemo_MorenoBioRxiv/2022_02_16_Data/LSM710/")
